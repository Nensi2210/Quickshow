  ...
  return (
    ...
    >
      ...
      <div
        ...
        bg-black/80 md:bg-white/10 md:border border-gray-300/20
      ...
      <div className='flex items-center gap-8'>
        ...
        {!user ? (
          <button
            ...
            className='px-4 py-1 sm:px-7 sm:py-2 bg-pink-600
            hover:bg-pink-700 transition rounded-full font-medium cursor-pointer'
          >
            Login
          </button>
        ) : (
