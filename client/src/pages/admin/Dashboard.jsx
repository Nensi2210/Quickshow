...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    setDashboardData({
      ...
      totalRevenue: 54000,
      totalUser: 85,
      activeShows: dummyShowsData.map((movie) => ({
        _id: movie._id,
        showPrice: 250,
    ...
    <>
      ...
      <div className="relative flex flex-wrap gap-6 mt-4 max-w-5xl">
        ...
        {dashboardData.activeShows.map((show) => (
          <div
            key={show._id}
            className="w-[220px] rounded-lg overflow-hidden pb-3 bg-primary/10 border border-primary/20 hover:-translate-y-1 transition duration-300"
          >
            <img
